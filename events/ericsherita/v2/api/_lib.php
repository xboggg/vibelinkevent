<?php
// Shared helpers for ericsherita.vibelinkevent.com/v2 APIs

const DATA_DIR       = __DIR__ . '/../data';
const VOICE_DIR      = __DIR__ . '/../data/voice';
const ADMIN_KEY      = 'ericsherita-fam-2026';

const MAX_RSVP       = 800;
const MAX_WISHES     = 1500;
const MAX_VOICE      = 500;
