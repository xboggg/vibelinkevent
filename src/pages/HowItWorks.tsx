...
const steps = [
  ...
  },
  {
    ...
    description: "Same-day WhatsApp confirmation.",
    details: "You see your quote instantly in the calculator. Our team then reaches out on WhatsApp the same day to confirm details, answer any questions, and discuss your vision before payment.",
    duration: "Same day",
    color: "from-primary to-secondary",
    bgColor: "bg-primary",
