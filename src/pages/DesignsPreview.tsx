// Preview of the new browse-all "Designs" page (option B rebuild of /templates).
// Live at /designs-preview so Edmund can approve before we replace /templates.
...
export default function DesignsPreview() {
  ...
  return (
    <Layout>
      <SEO
        title="Designs — Preview & Order"
        description="Browse VibeLink Event designs by event type. Preview any design live, then order it — priced separately at /pricing."
        canonical="/designs-preview"
      />
      ...
      <section className="pt-24 lg:pt-32 pb-10 bg-gradient-to-b from-[#6B46C1] via-[#553C9A] to-[#44337A] text-white">
        <div className="container mx-auto px-4 lg:px-8 text-center">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/15 border border-white/25 text-xs font-bold uppercase tracking-widest mb-4 backdrop-blur">
            <Sparkles className="w-3.5 h-3.5" /> Designs Preview
          </div>
