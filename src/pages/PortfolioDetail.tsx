...
const portfolioData: Record<string, {
  ...
  "wo1-deku-memorial": { demoLabel: "Open Demo",
    title: "A Soldier's Final Salute — Military Memorial",
    type: "Funeral",
    ...
    demoUrl: "https://demo-deku.vibelinkevent.com/",
    ...
    story: "A retired officer's family approached us to create a fitting digital tribute for their beloved, who served in the Ghana Armed Forces across a distinguished military career. They wanted something that honored his service while celebrating his role as a loving father and family man. We designed an elegant military-themed memorial page with a dignified color scheme of deep green and gold, featuring his service history, family tributes, and all the funeral arrangements. The page helped coordinate family members across Ghana and abroad for the funeral, burial, and thanksgiving services.",
  ...
  "charles-taylor-memorial": { demoLabel: "Open Demo",
