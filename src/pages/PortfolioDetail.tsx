...
const portfolioData: Record<string, {
  ...
  "eric-sherita-save-the-date": { demoLabel: "Open Invitation",
    ...
    type: "Wedding",
    description: "An editorial Save-the-Date for Eric Osei & Sherita Amelyn Tenda — Saturday, 28 November 2026 at 12PM, New Jersey. Sage-green, ivory and warm-gold palette lifted directly from the couple's paper card, with a cinematic splash-to-hero storytelling flow: gold rings on ivory lace fade into a full-bleed golden-hour walk.",
    image: "/ericsherita-detail.jpg",
