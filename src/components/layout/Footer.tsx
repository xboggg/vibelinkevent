        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="text-center md:text-left md:ml-4 lg:ml-8">
            ...
            <ul className="space-y-3">
              ...
              {/* WhatsApp — the primary channel. Number line links to wa.me
                  (opens chat). "Call" link uses tel: (fires system dialer).
                  Two distinct actions so "Chat or call" is literally true,
                  not just accurate-if-you-know-WhatsApp. */}
              <li className="flex items-start justify-center md:justify-start gap-3 text-sm">
                ...
                <div className="flex-1 min-w-0">
                  <a href="https://wa.me/4915757178561" target="_blank" rel="noopener noreferrer" className="block text-primary-foreground/70 hover:text-secondary transition-colors">
                    +49 157 5717 8561
                  </a>
                  <div className="flex items-center gap-2 mt-1 text-xs">
                    <a
                      ...
                      className="inline-flex items-center gap-1 text-primary-foreground/60 hover:text-secondary transition-colors underline-offset-2 hover:underline"
                    >
                      Chat
                    </a>
                    ...
                    <span className="text-primary-foreground/30">·</span>
                    <span className="text-primary-foreground/50">free worldwide</span>
                  </div>
                </div>
              </li>
              <li className="flex items-center justify-center md:justify-start gap-3 text-sm">
